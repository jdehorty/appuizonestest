...
import isolateSvg from "@bentley/icons-generic/icons/isolate.svg";
...
// Make sure the window closes when the component unmounts
    ...
    public render() {
        ...
        const iconSpec = IconSpecUtilities.createSvgIconSpec(isolateSvg);
       
        console.log("isolateSvg => [" + isolateSvg + "]  " + "iconSpec =>  [" + iconSpec + "]");
        ...
        let wrappedWidget =
            <div>
                <button style={btnStyle} className="uicore-buttons-hollow sstc-isolate-button">
                ...
                {/* <SvgPath viewBoxWidth={200} viewBoxHeight={200} paths={[
        ...
        let renderedContent = ReactDOM.createPortal(wrappedWidget, this.state.containerElement);
