// import { Config, UrlDiscoveryClient } from "@bentley/imodeljs-clients";
...
// import InitRpc from "../../ml-labeler-master/ml-labeler-master/IModelJsLabeler/imodeljs-labeler-prototype/src/frontend/api/rpc";
...
// import { SelectionExtender } from "../../ml-labeler-master/ml-labeler-master/IModelJsLabeler/imodeljs-labeler-prototype/src/frontend/app/SelectionExtender2";
...
export class LabelingApp {
    ...
    public static startup(/*opts?: IModelAppOptions*/): void {
        ...
        //     initPromises.push(UiFramework.initialize(this.store, IModelApp.i18n, undefined, "frameworkState"));
        //
